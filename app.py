...
async def init_browser():
    ...
    browser = await launch(headless=True, handleSIGINT=False, handleSIGTERM=False, handleSIGHUP=False,executablePath='chromium-browser',loop=loop,args=['--no-sandbox', '--disable-setuid-sandbox'])
    # 返回浏览器实例
    return browser
