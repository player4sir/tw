...
async def init_browser():
    ...
    browser = await launch(headless=True, handleSIGINT=False, handleSIGTERM=False, handleSIGHUP=False,executablePath='/opt/render/.local/share/pyppeteer/local-chromium/588429/chrome-linux/chrome/chrome',loop=loop,args=['--no-sandbox', '--disable-setuid-sandbox'])
    # 返回浏览器实例
    return browser
